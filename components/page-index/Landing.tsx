        ...
        <FormContainer>
          <div className="title-container">
            ...
            <p className="login_p2">
              Click <Link href="/#">here</Link> to sign up.
            </p>
          </div>
...
const Input = styled.input`
  ...
  ${(props) => props.theme.global.setInputFocus(lighten(0.3, 'black'))}
`;

const Button = styled.button<{ isSubmitting?: boolean }>`
  display: block;
  width: 100%;
  background: ${({ isSubmitting }) => (isSubmitting ? 'lightgray' : 'black')};
  color: white;
  ...
  &:hover {
    background: ${(props) => (props.isSubmitting ? 'lightgray' : lighten(0.1, 'black'))};
  }
